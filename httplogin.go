...
func main() {
	...
	resp, err := http.Post(paracheck, "application/x-www-form-urlencoded", strings.NewReader(fmt.Sprintf(`{"do":"plat-token-login","data":{"gameid":170,"platinfo":{"account":"official","platid":"67","email":"whj@whj.whj","gender":"male","nickname":"navy1125","timestamp":"12345","uid":"321","sign":"%s"}}}`, sign)))
